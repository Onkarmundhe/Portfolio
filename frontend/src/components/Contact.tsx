          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a 
                    href="mailto:onkarmundhe995@gmail.com" 
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.linkedin.com/in/onkar-mundhe" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
